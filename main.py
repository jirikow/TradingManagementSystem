...
cboChooseaCar = ttk.Combobox(bottomLeftTopR, textvariable= var6, state='readonly', font=('arial', 20, 'bold'), width=12)
...
cboTradeInaCar = ttk.Combobox(bottomLeftTopR, textvariable= var7, state='readonly', font=('arial', 20, 'bold'), width=12)
